...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="52"
	TMUX_POWERLINE_SEG_AIR_LON="4"
...
# mailcount.sh {
	...
	#export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/ranjit/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	#export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/mail/ranjit"
	
	## mailcheck
	# Optional path to mailcheckrc
	#export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/ranjit/.mailcheckrc"
# }
...
# mode_indicator.sh {
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_PREFIX_MODE_TEXT_COLOR="33"
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/ranjit/.now_playing.log"
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="52"
	TMUX_POWERLINE_SEG_WEATHER_LON="4"
# }
